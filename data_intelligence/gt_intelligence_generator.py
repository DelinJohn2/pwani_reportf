...
def intelligence_maker_gt(rtm_data, gt_data, competitor_data, brand,territory,threshold=0.05):
    ...
    category=gt_filtered['category'].iloc[0]   
...
"rift valley": "Agricultural communities, seasonal income, large households, bulk purchasing, pastoralist influence, resource scarcity concerns, community word-of-mouth important, diverse ethnic groups, farming calendar impacts, livestock considerations",
    ...
    return {
            ...
            'category':category,
            'territory':territory,
            'rtm_data':filtered_rtm.to_csv(), 
            'gt_data':gt_filtered.to_csv(), 
            'external_comp':filtered_comp.to_csv(), 
            'internal_comp':inter_filtered.to_csv(),
